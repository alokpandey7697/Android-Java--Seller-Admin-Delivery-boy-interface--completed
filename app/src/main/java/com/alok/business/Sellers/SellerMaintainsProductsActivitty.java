...
public class SellerMaintainsProductsActivitty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Seller Edit");
...
//                finish();
                ...
                Toast.makeText(SellerMaintainsProductsActivitty.this, "The product is deleted successfully", Toast.LENGTH_SHORT).show();
        ...
        else
        {
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(SellerMaintainsProductsActivitty.this, "Changes applied successfully", Toast.LENGTH_SHORT).show();
                        finish();
//                        Intent intent=new Intent(AdminMaintainsProductsActivity.this, SellerProductCategoryActivity.class);
//                        startActivity(intent);
//                        finish();
